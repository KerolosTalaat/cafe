...
const AddBarista = ({ signUp, auth, errorMessage }) =>{
	const [ user, addUser] = useState({ firstName : '', lastName : '', email : '', password : '',role: '153',isOnline:'offline'});
...
export default connect(mapStateToProps, { signUp })(AddBarista);