...
const AddCashier = ({ signUp, auth, errorMessage }) =>{
	const [ user, addUser] = useState({ firstName : '', lastName : '', email : '', password : '',role: '151',isOnline:'offline'});
...
export default connect(mapStateToProps, { signUp })(AddCashier);