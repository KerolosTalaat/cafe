...
const AddManager = ({ signUp, auth, errorMessage }) =>{
	const [ user, addUser] = useState({ firstName : '', lastName : '', email : '', password : '',role: '150',isOnline:'offline'});
...
export default connect(mapStateToProps, { signUp })(AddManager);